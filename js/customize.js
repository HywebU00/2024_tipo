...
$(document).ready(function () {
  ...
  function toggleContent(expand) {
    if (expand) {
      ...
      advSearchButton.addClass('active').attr('aria-expanded', 'true').text('關閉條件查詢'); // 切換按鈕文字
      // focusableElements.first().focus();
    } else {
      advSearchContent.slideUp().attr('hidden', true);
      advSearchButton.removeClass('active').attr('aria-expanded', 'false').text('顯示條件查詢'); // 切換回原來的文字
...
//     let node3Height = $('.node3').outerHeight() || 0;
...
//       $('.nodeMenu').css('height', `${node3Height + nextHeight + 16}px`);
//       $('.nodeMenu li.active')
//         .children('ul')
//         .css('top', `${parentHeight + 16}px`);
//     } else {
//       $('.nodeMenu').css('height', `${node3Height + nextHeight + m4BtnHeight + m3BtnHeight + 10}px`);
//       $('.nodeMenu li.active')
//         .children('ul')
//         .css('top', `${node3Height + m4BtnHeight + m3BtnHeight + 10}px`);
//       $('.nodeMenu li.active .m4Btn').css('top', `${node3Height + m3BtnHeight}px`);
//     }
//   }
// });
$(function () {
